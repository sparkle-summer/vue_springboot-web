        ...
        <div style="margin-top: 35px;">
          <el-row>
            <el-form-item label="统一认证号" prop="userId">
              <div class="block">
                <el-input style="width: 210px" v-model="qrParams.userId" :disabled="true"/>
              </div>
            </el-form-item>
            <el-form-item label="用户名" prop="userNm">
              <div class="block">
                <el-input style="width: 210px" v-model="qrParams.userNm" :disabled="true"/>
              </div>
            </el-form-item>
            <el-form-item label="手机号" prop="mobile">
              <div class="block">
                <el-input style="width: 210px" v-model="qrParams.mobile" />
              </div>
            </el-form-item>
            ...
            <el-form-item label="二维码颜色(选输)" prop="qrColor">
              <div>
                <el-color-picker style="width: 210px" v-model="qrParams.qrColor" />
              </div>
            </el-form-item>
            ...
            <el-form-item>
              ...
              <el-button style="width:90px;margin:8px" type="primary" icon="el-icon-share" 
                :disabled="codeBtnDisabled" @click="creatQrCode()">生成</el-button>
            </el-form-item>
          </el-row>
        </div>
      </el-form>
...
import { generateQrCodeReq, generateQrCodeDto, generateQrCodeLogo} from '@/api/fw/qrcode'
